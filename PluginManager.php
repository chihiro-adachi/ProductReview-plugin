...
class PluginManager extends AbstractPluginManager
{
    private $pages = [
        [
            ...
            'filename' => 'ProductReview4/default/review',
        ],
        [
            'name' => 'レビューを投稿',
            'url' => 'product_review_index',
            'filename' => 'ProductReview4/default/index',
        ],
        [
            'name' => 'レビューを投稿(確認)',
            'url' => 'product_review_confirm',
            'filename' => 'ProductReview4/default/confirm',
        ],
        [
            'name' => 'レビューを投稿(完了)',
            'url' => 'product_review_complete',
            'filename' => 'ProductReview4/default/complete',
        ],
    ];
